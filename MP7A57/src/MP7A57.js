class MP7A57
{
    ...
    load()
    {
        const config = common_f.json.deserialize(common_f.vfs.readFile(`${core_f.packager.getModPath(this.modname)}Config.json`));
        ...
        const itemFleaPrice = config.Flea_Cost_Rubles;
        ...
        const itemTraderPrice = config.Peacekeeper_Cost_Dollars;
